    ...
    <div>
      <div className=" p-4 flex-col text-base justify-between bg-[#222222] rounded-lg mx-3">
        <div className="mx-3">
          <a
            href="#"
            className="card w-auto  h-auto py-2 text-lg px-3 hover:bg-[#0c0c0c] bg-[#2c2c2c] border-white border-2 rounded-md m-1 flex items-center gap-1"
          >
          ...
          <ul className="list-disc my-2">
            ...
            <li>Bookmark a page to access it from the extension</li>
